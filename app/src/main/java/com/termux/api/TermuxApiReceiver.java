...
public class TermuxApiReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    try {
      ...
      // Make sure never to throw exception from BroadCastReceiver to avoid "process
      // is bad"
  ...
  private void doWork(Context context, Intent intent) {
    ...
    switch (apiMethod) {
      ...
      case "Share":
        ...
        break;
      case "SmsInbox":
        if (TermuxApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.READ_SMS,
            Manifest.permission.READ_CONTACTS)) {
